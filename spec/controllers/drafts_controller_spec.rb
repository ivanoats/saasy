...
describe DraftsController do
  ...
  describe "GET show" do
    it "assigns the requested draft as @draft" do
      draft = Draft.create! valid_attributes
      get :show, {:id => draft.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested draft as @draft" do
      draft = Draft.create! valid_attributes
      get :edit, {:id => draft.to_param}, valid_session
      assigns(:draft).should eq(draft)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Draft" do
        expect {
          post :create, {:draft => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved draft as @draft" do
        ...
        post :create, {:draft => { "body" => "invalid value" }}, valid_session
        assigns(:draft).should be_a_new(Draft)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested draft" do
        ...
        Draft.any_instance.should_receive(:update_attributes).with({ "body" => "MyText" })
        put :update, {:id => draft.to_param, :draft => { "body" => "MyText" }}, valid_session
      end

      it "assigns the requested draft as @draft" do
        draft = Draft.create! valid_attributes
        put :update, {:id => draft.to_param, :draft => valid_attributes}, valid_session
        assigns(:draft).should eq(draft)
      end
    ...
    describe "with invalid params" do
      it "assigns the draft as @draft" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Draft.any_instance.stub(:save).and_return(false)
        put :update, {:id => draft.to_param, :draft => { "body" => "invalid value" }}, valid_session
        assigns(:draft).should eq(draft)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested draft" do
      draft = Draft.create! valid_attributes
      expect {
        delete :destroy, {:id => draft.to_param}, valid_session
      }.to change(Draft, :count).by(-1)
    end
